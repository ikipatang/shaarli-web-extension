...
- Show menu active when 2 URL are provided
- Improve stability
- Update dependencies
- Remove xpi-release directory
...
### Added
- Add option to retrieve automatically description

### Fixed
- Share url use correctly shaarli url

## [2.1.1][] - 2025-05-25

### Added
- Handle alternate shaarli url
- Add mobile support
